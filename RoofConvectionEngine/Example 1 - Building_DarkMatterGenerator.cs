...
namespace DarkMatterGenerator
{
    ...
    public class Building_DarkMatterGenerator : Building
    {
        ...
        //Custom Vars
        private float TenDegreeDeltaThermalEnergyPerSecond = 21f;
        ...
        private float TenDegreeDeltaPowerGeneration = 20f;
        ...
        public float HeatOutput() {
            ...
            if (ambient < target && ambient < outside) {
                ...
                //case remove heat
                return Math.Max(target - ambient, ambient - outside) / 10f * TenDegreeDeltaThermalEnergyPerSecond;
            }
            return 0f;
        }
        ...
        private void DoTickerWork(int tickerAmount){
            ...
            powerComp.PowerOutput = EnergyOutput(HeatOutput());
        }
        ...
        public override string GetInspectString(){
            ...
            stringBuilder.Append("Heat Output");
            stringBuilder.Append(string.Format("{0:N8}", HeatOutput()));
